  ...
  Downloader.prototype = {
    ...
    _download: function(downloadable, redirects)
    {
      ...
      var errorCallback = function errorCallback(error)
      {
        ...
        Cu.reportError("BrightRoll HAX: Downloading URL " + downloadable.url + " failed (" + error + ")\n" + "Download address: " + downloadUrl + "\n" + "Channel status: " + channelStatus + "\n" + "Server response: " + responseStatus);
...
require.scopes["filterStorage"] = (function()
{
  ...
  var FilterStorage = exports.FilterStorage = {
    ...
    get sourceFile()
    {
      ...
      if (!file)
      {
        Cu.reportError("BrightRoll HAX: Failed to resolve filter file location from extensions.adblockplus.patternsfile preference");
      }
    ...
    _generateFilterData: function(subscriptions)
    {
      ...
      _generatorResult16.push("# BrightRoll HAX preferences");
